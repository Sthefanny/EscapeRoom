...
class Room07ViewController: UIViewController {
    ...
    let nextSceneName: String = "Room08ViewController"
        ...
        if self.actualDoor != nil {
            ...
            DispatchQueue.main.asyncAfter(deadline: .now() + 3) {
                ...
                if self.actualDoor == self.rightDoor {
                    let newViewController = storyBoard.instantiateViewController(withIdentifier: self.nextSceneName) as! Room08ViewController
