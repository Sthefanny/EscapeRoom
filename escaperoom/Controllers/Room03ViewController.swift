...
class Room03ViewController: UIViewController {
    ...
    let nextSceneName: String = "Room04ViewController"
        ...
        if self.actualDoor != nil {
            ...
            DispatchQueue.main.asyncAfter(deadline: .now() + 3) {
                ...
                if self.actualDoor == self.rightDoor {
                    let newViewController = storyBoard.instantiateViewController(withIdentifier: self.nextSceneName) as! Room04ViewController
